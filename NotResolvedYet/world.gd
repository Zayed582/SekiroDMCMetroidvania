...
@onready var beam_scene = preload("res://Bosses/LaserBeam/Effects/Beam/light_beam.tscn")

func _ready():
	$UI/DeathMenu/Button.pressed.connect(_on_Button_pressed)
	var test_clone = preload("res://Bosses/LaserBeam/laserbeam_boss.tscn").instantiate()
