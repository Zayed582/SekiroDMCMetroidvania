...
@onready var shockwave_scene = preload("res://shockwave.tscn")
var nova_triggered := false
var boss_camera = preload("res://boss_camera.tscn").instantiate()
@onready var clone_scene = preload("res://laserbeam_clone.tscn")  # This should be a translucent version of Xarion
...
@onready var orb_scene = preload("res://solar_orb.tscn") 
@onready var anim = $AnimatedSprite2D
@onready var parry_area = $ParryTagArea
@onready var attack_area = $AttackArea
@onready var laser_scene = preload("res://light_beam.tscn")
